...
# 결과 엑셀 파일 초기 생성
file_path = "C:/Users/ilpus/Desktop/git_folder/TQQQ_MA/TECL_MA_AGG4m.xlsx"
...
# QLD 데이터
TECL = yf.download('TECL', start='2010-02-09', auto_adjust=True, interval='1d', progress=True, multi_level_index=False)
TECL.drop(['Open','High','Low','Volume'], axis=1, inplace=True)
