...
print(integer.iloc[-1],integer.iloc[-2]) #현재 캔들 기준의 값과 이전 캔들 기준의 값
...
print("--------------------BBANDS-------------------------")
#이전 캔들의 값
print(upperband.iloc[-2],middleband.iloc[-2],lowerband.iloc[-2])

#현재 캔들의 값(변동 중...)
print(upperband.iloc[-1],middleband.iloc[-1],lowerband.iloc[-1])
print("---------------------------------------------------")
...
print(real.iloc[-1], real.iloc[-2]) #현재 캔들 기준의 값과 이전 캔들 기준의 값
...
print(fastk.iloc[-2],fastd.iloc[-2])
print(fastk.iloc[-1],fastd.iloc[-1])
