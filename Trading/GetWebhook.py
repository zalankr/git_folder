    ...
    if data['type'] == "market":
        ...
        if data['etc_str'] == "open":
            ...
            if data['side'] == "long":
                ...
                print(bybitX.create_order(data['ticker'], 'market', 'buy', data['amt'], None, {'position_idx':1}))
                
            elif data['side'] == "short":
                #print(bybitX.create_market_sell_order(data['ticker'], data['amt']))
                print(bybitX.create_order(data['ticker'], 'market', 'sell', data['amt'], None, {'position_idx':2}))

        elif data['etc_str'] == "close":
            
            if data['side'] == "long":
                #print(bybitX.create_market_buy_order(data['ticker'], data['amt'],{'reduce_only': True,'close_on_trigger':True}))
                print(bybitX.create_order(data['ticker'], 'market', 'buy', data['amt'], None,{'position_idx':1,'reduce_only': True,'close_on_trigger':True}))
            elif data['side'] == "short":
                #print(bybitX.create_market_sell_order(data['ticker'], data['amt'],{'reduce_only': True,'close_on_trigger':True}))
                print(bybitX.create_order(data['ticker'], 'market', 'sell', data['amt'], None, {'position_idx':2,'reduce_only': True,'close_on_trigger':True}))
        ...
        if data['etc_str'] == "open":
            ...
            if data['side'] == "long":
                ...
                print(bybitX.create_order(data['ticker'], 'limit', 'buy', data['amt'], data['price_money'], {'position_idx':1}))
            elif data['side'] == "short":
                #print(bybitX.create_limit_sell_order(data['ticker'], data['amt'], data['price_money']))
                print(bybitX.create_order(data['ticker'], 'limit', 'sell', data['amt'], data['price_money'], {'position_idx':2}))
            ...
            if data['side'] == "long":
                ...
                print(bybitX.create_order(data['ticker'], 'limit', 'buy', data['amt'], data['price_money'] ,{'position_idx':1,'reduce_only': True,'close_on_trigger':True}))
            elif data['side'] == "short":
                #print(bybitX.create_limit_sell_order(data['ticker'], data['amt'], data['price_money'],{'reduce_only': True,'close_on_trigger':True}))
                print(bybitX.create_order(data['ticker'], 'limit', 'sell', data['amt'], data['price_money'] ,{'position_idx':2,'reduce_only': True,'close_on_trigger':True}))
