...
# KIS instance 생성
key_file_path = "/var/autobot/KIS/kis44036546nkr.txt"
token_file_path = "/var/autobot/KIS/kis44036546_token.json"
cano = "44036546"
acnt_prdt_cd = "01"
...
# 모드 및 종목 설정
# ============================================
MODE       = "BUY"          # "BUY"(분할매수) 또는 "SELL"(분할매도)
TICKER     = "498400"
...
SELL_TRADE_DAYS = 10           # 총 거래일 수 (분할매도일 수)
SELL_SPLIT      = 4            # 일 분할 횟수
