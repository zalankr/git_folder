...
# KIS instance 생성
key_file_path = "/var/autobot/KIS/kis43680827lys.txt"
token_file_path = "/var/autobot/KIS/kis43680827_token.json"
cano = "43680827"
acnt_prdt_cd = "01"
...
def target_invest(target: dict, this_krw_asset: float):
    ...
    if abs(total_weight - 1.0) > 0.01:   # 1% 오차 허용
        TA.send_tele(f"ISAYS 경고: weight 합계 = {total_weight:.3f} (1.0 아님). 계속 진행합니다.")
