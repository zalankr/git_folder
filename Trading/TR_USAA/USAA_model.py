...
#### 사용 안 하게 USAA_Trading 코드에 모든 기능을 합칠 것!!!
class USAA(KIS_US.KIS_API): #상속
    def __init__(self, key_file_path, token_file_path, cano, acnt_prdt_cd):
        ...
        self.USLA_ticker = ['UPRO', 'TQQQ', 'EDC', 'TMV', 'TMF']
        self.HAA_ticker = ['TIP', 'SPY', 'IWM', 'VEA', 'VWO', 'PDBC', 'VNQ', 'TLT', 'IEF', 'BIL']
        self.all_tickers = self.USLA_ticker + self.HAA_ticker + ['CASH']
        self.USAA_data_path = "/var/autobot/TR_USAA/USAA_data.json"
        self.USAA_TR_path = "/var/autobot/TR_USAA/USAA_TR.json"
