...
class ETFMomentumStrategy:
    ...
    def calculate_regime_signal(self, target_month, target_year):
        ...
        try:
            ...
            print(f"AGG 현재가: {current_price:.2f}")
            print(f"AGG 4개월 평균: {avg_price:.2f}")
            print(f"Regime Signal: {regime_signal:.2f}")
    ...
    def run_strategy(self, target_month=None, target_year=None):
        ...
        print(f"\n=== {target_year}년 {target_month}월 ETF 모멘텀 전략 실행 ===")
